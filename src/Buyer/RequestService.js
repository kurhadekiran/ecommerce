...
const placeholderImageUrl = '/email.jpeg';
...
export default function RequestService()
{
  ...
  const sendEmail = (e) => {
    e.preventDefault();
    emailjs
      .sendForm('service_5rovtlb', 'template_axmjueb', form.current, {
        publicKey: 'OlT0IfaQ4UpC6G9G2',
      })
      .then(
        () => {
...
<div class="container">
    <div class="row justify-content-md-center">
      <div class="col-12 col-md-10 col-lg-8 col-xl-7 col-xxl-6">
        ...
        <p class="text-secondary mb-5 text-center">🖊️Buyer  send confirmation status to the Investor for it appropriate Product order..✏️</p>
  ...
  <div class="container d-flex justify-content-center ">
    <div class="row gy-3 gy-md-4 gy-lg-0 align-items-xl-center">
      <div class="col-12 col-lg-6">
        <img class="img-fluid rounded" loading="lazy"  src={placeholderImageUrl} alt="heropageImg" style={{height:'550px'}}/>
      </div>
